...
public class Test6Util {
    ...
    public static int loadShader(int shaderType, String sourceCode) {
        ...
        if (shader == 0) {
            Log.e(Test6Activity.TAG, "Could not create new shader!");
        }
        ...
        if (compiled[0] != GLES20.GL_TRUE) {
            Log.e(Test6Activity.TAG, "Could not compile shader: " + shader);
            Log.e(Test6Activity.TAG, "GLES2.0 Error: " + GLES20.glGetShaderInfoLog(shader));
    ...
    public static int createOpenGLESProgram(int vertexShader, int fragmentShader) {
        ...
        if (status[0] != GLES20.GL_TRUE) {
            Log.e(Test6Activity.TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(program));
