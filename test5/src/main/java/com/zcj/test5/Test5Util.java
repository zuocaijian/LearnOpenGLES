...
public class Test5Util {
    ...
    public static int loadShader(int shaderType, String sourceCode) {
        ...
        if (shader == 0) {
            Log.e(Test5Activity.TAG, "Could not create new shader!");
        }
        ...
        if (compiled[0] != GLES20.GL_TRUE) {
            Log.e(Test5Activity.TAG, "Could not compile shader: " + shader);
            Log.e(Test5Activity.TAG, "GLES Error: " + GLES20.glGetShaderInfoLog(shader));
    ...
    public static int createOpenGLESProgram(int vertexShader, int fragmentShader) {
        ...
        if (status[0] != GLES20.GL_TRUE) {
            Log.e(Test5Activity.TAG, "Could not link program:" + GLES20.glGetProgramInfoLog(program));
