...
public class Test8Util {
    ...
    public static int loadShader(int shaderType, String sourceCode) {
        ...
        if (shader == 0) {
            Log.e(Test8Activity.TAG, "Could not create new shader!");
        }
        ...
        if (compiled[0] != GLES20.GL_TRUE) {
            Log.e(Test8Activity.TAG, "Could not compile shader: " + shader);
            Log.e(Test8Activity.TAG, "GLES20 Error: " + GLES20.glGetShaderInfoLog(shader));
    ...
    public static int createOpenGLESProgram(int vertexShader, int fragmentShader) {
        ...
        if (program == 0) {
            Log.e(Test8Activity.TAG, "Could not create new program!");
        }
        ...
        if (status[0] != GLES20.GL_TRUE) {
            Log.e(Test8Activity.TAG, "Could not link program: " + program);
            Log.e(Test8Activity.TAG, "GLES20 Error: " + GLES20.glGetProgramInfoLog(program));
